...
const it: Dict = {
  ...
  'showCode.errorShareBody': 'Non sono riuscito ad aprire la condivisione.',
...
const en: Dict = {
  ...
  'showCode.errorShareBody': "I couldn't open sharing.",
